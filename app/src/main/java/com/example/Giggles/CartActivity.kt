...
//            intent.putExtra("selectedView",selectedView)
        ...
        if (view=="Home"|| view=="Profile" || view=="Community"){
    ...
    private fun getroomdata() {
        ...
        val products: MutableList<Product?>? = productDao?.getallproduct()
        val adapter = myadapter(products, rateview)
